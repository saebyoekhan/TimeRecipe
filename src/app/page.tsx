...
export default function HomePage() {
  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-center px-6 py-12 overflow-hidden wood-bg">
      {/* 헤더 */}
      <motion.div
      ...
      <AnimatePresence>
        {showRecipes && (
          ...
          >
            <p className="text-xs text-center text-brown-light/60 mb-4">
              🍽️ 레시피를 선택하세요
            </p>
            <RecipeCarousel />
          </motion.div>
